...
function FeaturedProductsBox({country}) {
  ...
  //   : null;
  return (
    <div className="bg-white p-12 shadow-xl rounded-xl mt-10">
        ...
        return (
          <>
            <div className="flex justify-between items-center mb-8 text-md font-medium">
              <span className="text-black uppercase">{collection.title}</span>
...
function FeaturedCollectionBox({country}) {
  ...
  return <FeaturedCollection collections={collections} />;
}
